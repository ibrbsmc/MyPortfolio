...
transition={{ duration: 0.3 }}
    ...
    <Container className='lp-container'>
      ...
      <Card className='icon-mainc-about'>
        ...
        <div className='logos-name'><img src="https://static.cdnlogo.com/logos/s/63/sass.svg"></img>SASS</div>
        <div className="logos-name"><img src="https://static.cdnlogo.com/logos/t/96/typescript.svg"></img>TS</div>
        <div className="logos-name"><img src="https://static.cdnlogo.com/logos/t/58/tailwindcss.svg"></img>TAILWIND</div>
        <div className="logos-name"><img src="https://static.cdnlogo.com/logos/v/23/vitejs.svg"></img>VITE</div>
        <div className="logos-name"><img src="https://static.cdnlogo.com/logos/c/36/canva.png"></img>CANVA</div>
        <div className="logos-name"><img src="https://static.cdnlogo.com/logos/a/24/amazon-mobile-services.svg"></img>RESPONSIVE DESIGN</div>
        </Card.Text>
        </div>
        </Card.Body>
      </Card>
